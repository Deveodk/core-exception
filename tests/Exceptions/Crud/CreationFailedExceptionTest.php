...
use DeveoDK\Core\Exception\Exceptions\Crud\CreationFailedException;
use Orchestra\Testbench\TestCase;

class CreationFailedExceptionTest extends TestCase
{
    ...
    {
        $exception = new CreationFailedException();

        $this->assertEquals('A1000', $exception->getCoreExceptionCode());
    }
