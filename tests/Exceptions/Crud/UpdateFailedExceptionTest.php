...
use DeveoDK\Core\Exception\Exceptions\Crud\UpdateFailedException;
use Orchestra\Testbench\TestCase;

class UpdateFailedExceptionTest extends TestCase
{
    ...
    public function canFindExceptionCode()
    {
        ...
        $this->assertEquals('A3000', $exception->getCoreExceptionCode());
    }
