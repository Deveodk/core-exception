...
use DeveoDK\Core\Exception\Exceptions\Crud\DeleteFailedException;
use Orchestra\Testbench\TestCase;

class DeletionFailedExceptionTest extends TestCase
{
    ...
    {
        $exception = new DeleteFailedException();

        $this->assertEquals('A2000', $exception->getCoreExceptionCode());
    }
